...
<<<<<<< HEAD
        ...
        //if ARMv7 or ARMv8
        if((READ_SYSREG( p15,0,c0,c1,2) & 0x1111) == 0x1010 || (READ_SYSREG( p15,0,c0,c1,2) & 0x0101))
        {
...
>>>>>>> 0cffa5bfe25e14e94d434b0bb19a1143bf76cc02
        {
            //##########################################
            //##################ARMv8###################
            //##########################################
            ...
            */
            WRITE_SYSREG(READ_SYSREG(p14,0,c0,c2,2) | 0x1 ,p14,0,c0,c2,2 );
            
            /*MDCR_EL2.[TDE==8] == 1
            debug exceptions routed to EL2
            */
            WRITE_SYSREG(READ_SYSREG(MDCR_EL2) | 0x100, MDCR_EL2);
            ...
            */
            ...
            /*SPSR_EL2.SS[21==0x200000] write to PSTATE.SS == 1
            <systemreg> op0 op1 CRn  CRm  op2
            SPSR_EL3    11  110 0100 0000 000
           
            */
            WRITE_SYSREG(READ_SYSREG(p14,0,c4,c0,0) | 0x200000, MDCR_EL2);


            //EXECUTE ERET
            gprintk(XENLOG_ERR, "[After] Reading MDSCR_EL1:      0x%x\n", READ_SYSREG( p14,0,c0,c2,2));
            gprintk(XENLOG_ERR, "[After] Reading MDCR_EL2:       0x%x\n", READ_SYSREG( MDCR_EL2));
